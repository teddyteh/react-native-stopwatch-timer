...
class StopWatch extends Component {
    ...
    start() {
        const handleFinish = this.props.handleFinish ? this.props.handleFinish : null;
        ...
        const startTime = this.props.startTime ? this.props.startTime : new Date();
        this.setState({
        ...
        this.interval = this.interval ? this.interval : setInterval(() => {
            this.setState({elapsed: new Date() - this.state.startTime - this.state.pausedTime}, function () {
                if (this.props.totalDuration && this.state.elapsed > this.props.totalDuration) {
                    this.stop();
                    this.reset();
